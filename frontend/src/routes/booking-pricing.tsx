    ...
    <SiteLayout>
      <div className="min-h-screen bg-background">
        ...
        <div className="bg-[image:var(--gradient-hero)] px-6 pt-6 pb-10">
          <button onClick={() => navigate({ to: "/booking-datetime" })} className="text-white/80 hover:text-white mb-4 flex items-center gap-2 text-sm">
            <FaArrowLeft /> Back
          </button>
            ...
            {isCommercial ? (
              ...
              <>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => navigate({ to: "/booking-datetime" })}
